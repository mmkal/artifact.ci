...
test('take vitest screenshot', async ({page}) => {
  await page.goto(`${runBaseUrl}/vitest/vitest/html/index.html`)
...
test('take playwright screenshot', async ({page}) => {
  await page.goto(`${runBaseUrl}/playwright/playwright-report/index.html`)
...
test('take jest screenshot', async ({page}) => {
  await page.goto(`${runBaseUrl}/jest/report/jest_html_reporters.html`)
...
test('take mocha screenshot', async ({page}) => {
  await page.goto(`${runBaseUrl}/mocha/output.html`)
...
test('take eslint screenshot', async ({page}) => {
  await page.goto(`${runBaseUrl}/eslint/.eslint-config-inspector`)
...
test('take website screenshot', async ({page}) => {
  await page.goto(`${runBaseUrl}/website/demosite/dist/index.html`)
  await page.waitForSelector('text=Welcome to Starlight')
  await page.snapshotScreen()
})

test('take pdf screenshot', async ({page}) => {
  await page.goto(`${runBaseUrl}/pdf/output.pdf`)
