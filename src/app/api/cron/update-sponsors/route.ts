...
export declare namespace queries {
  ...
  /** - query: `insert into sponsors (sponsor_login, spo... [truncated] ...dated_at = current_timestamp returning *` */
  export interface Sponsor {
    ...
    /** column: `public.sponsors.github_type`, not null: `true`, regtype: `text` */
    github_type: string

    /** column: `public.sponsors.monthly_amount_usd`, regtype: `numeric(10,2)` */
  ...
  /** - query: `insert into usage_credits (github_login,... [truncated] ...dated_at = current_timestamp returning *` */
