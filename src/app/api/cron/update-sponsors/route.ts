...
export declare namespace queries {
  ...
  /** - query: `insert into sponsors select * from jsonb... [truncated] ..., sponsor_login, sponsoree_login, expiry` */
  ...
  /** - query: `insert into usage_credits select * from ... [truncated] ...github_login, expiry, sponsor_id, reason` */
