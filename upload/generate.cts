...
type BulkRequest = import('../src/app/artifact/upload/signed-url/types').BulkRequest
type BulkResponse = import('../src/app/artifact/upload/signed-url/types').BulkResponse
