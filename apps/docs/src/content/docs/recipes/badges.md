---
title: Badges
description: Generate shields.io-style badges that track your latest workflow run.
---

artifact.ci also provides a `badge` action, a thin wrapper around the artifact upload action which uses the [badge-maker](https://github.com/badges/shields) library (from shields.io) to generate badges.
...
![result checkmate](https://artifact.ci/artifact/blob/mmkal/artifact.ci/branch/main/result/badge.svg)
